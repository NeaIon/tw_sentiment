...
<body>
    <div id="content">
    <center><h1>O lista cu postarile de pe Twitter a user-ului SnookiLala</h1></center>
...
foreach($oXML->channel->item as $oDocuments){
		...
		echo "<center><a href='". $url. "'>". $url. "'</a></center><br/>";
		echo "<br/>Sentimentul acestui post este:<br/>";
		
		echo "<a href='http://www.sentiment140.com/api/classify?text=". urlencode($title). "'>http://www.sentiment140.com/api/classify?text=". urlencode($title). "'</a><br/>";
